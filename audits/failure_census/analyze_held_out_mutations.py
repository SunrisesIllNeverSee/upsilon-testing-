...
from upsilon.lineage.chain_reconstruction import AmendmentStep
from upsilon.parsing.amendment_parser import parse_v04
from upsilon.transformations.semantic_mapper import map_instruction
from upsilon.models.legacy_models import AmendmentInstruction, InstructionType, InstructionProvenance
...
def analyze_chain_mutations(
    ...
    for step in amendments:
        ...
        from upsilon.pipeline.semantic_pipeline import _parser_rows_to_instructions
