...
from commitment_extractor import ExtractionResult, ValidationItem
...
from semantic_pipeline import SemanticPipelineResult, run_semantic_pipeline
...
class TestClassifyFailureV2:
    ...
    def test_extraction_failure_categories_are_distinct_from_v1(self):
        ...
        from run_chain_study import FAILURE_CATEGORIES as V1_CATEGORIES
