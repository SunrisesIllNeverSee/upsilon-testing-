...
from upsilon.models.legacy_models import AmendmentInstruction, CommitmentState
...
def build_agreement_context(
    ...
    from upsilon.commitments.commitment_registry import get_aliases_for_class
