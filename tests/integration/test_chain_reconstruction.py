...
from upsilon.models.legacy_models import AmendmentInstruction, CommitmentState, ExecutionStatus, InstructionType
from tests.corpus.synthetic_chains import (
    all_chains,
    chain_acme,
    chain_beta,
    chain_delta,
...
def test_is_resolved_by_domain_effect_derives_field():
    ...
    same target."""
    from upsilon.models.legacy_models import DomainEffect
    unresolved = AmendmentInstruction(
        order=2,
        instruction_type=InstructionType.REPLACE_VALUE,
        target_key="financial_covenant.interest_coverage",
