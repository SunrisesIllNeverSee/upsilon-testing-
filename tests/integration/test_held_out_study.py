...
class TestIndependentAnnotators:
    ...
    def test_annotator_a_and_b_have_different_names(self):
        from data.create_held_out_gold import ANNOTATOR_A, ANNOTATOR_B
    ...
    def test_annotator_a_requires_section_prefix(self):
        ...
        from data.create_held_out_gold import _annotator_a_find_sections
    ...
    def test_annotator_b_accepts_bare_number(self):
        ...
        from data.create_held_out_gold import _annotator_b_find_sections
        text = (
    ...
    def test_annotators_produce_different_results_on_same_text(self):
        ...
        from data.create_held_out_gold import annotator_a_annotate, annotator_b_annotate
    ...
    def test_annotator_a_min_name_length_10(self):
        ...
        from data.create_held_out_gold import _annotator_a_extract_clauses
    ...
    def test_annotator_b_min_name_length_8(self):
        ...
        from data.create_held_out_gold import _annotator_b_extract_clauses
        text = "§9.1 ShortName\nThe Borrower shall maintain a leverage ratio.\n§9.2 Maximum Leverage Ratio\nThe ratio shall not exceed 4.0 to 1.0."
...
class TestDoubleAnnotation:
    ...
    def test_agreement_produces_adjudicated_record(self):
        from data.create_held_out_gold import double_annotate, ANNOTATOR_A, ANNOTATOR_B
        record = GoldRecord(
    ...
    def test_only_a_produces_single_record(self):
        from data.create_held_out_gold import double_annotate, ANNOTATOR_A
        record = GoldRecord(
            issuer="Test", document="CMP", section="§9.1",
            commitment_id="financial_covenant.leverage_ratio",
            field="threshold", value=3.5, unit="ratio",
    ...
    def test_only_b_produces_single_record(self):
        from data.create_held_out_gold import double_annotate, ANNOTATOR_B
        record = GoldRecord(
            issuer="Test", document="CMP", section="§9.1",
            commitment_id="financial_covenant.leverage_ratio",
            field="threshold", value=3.5, unit="ratio",
...
class TestHeldOutChainBuilding:
    ...
    def test_uses_manifest_text_path_not_hardcoded(self):
        ...
        from research.run_held_out_study import _build_held_out_chain_from_manifest_entry
    ...
    def test_no_dev_cik_overlap(self):
        _require_held_out_data()
        from upsilon.ingestion.acquire_held_out_study import DEV_CIKS
        manifest = json.loads(HELD_OUT_MANIFEST.read_text(encoding="utf-8"))
...
class TestGoldAgreementComputation:
    ...
    def test_compute_gold_agreement_with_matching_commitment(self):
        from research.run_held_out_study import compute_gold_agreement
...
class TestReportGeneration:
    ...
    def test_clopper_pearson_known_values(self):
        from research.generate_step_19b_report import clopper_pearson
...
class TestAcquireHeldOut:
    ...
    def test_target_chains_is_25(self):
        from upsilon.ingestion.acquire_held_out_study import TARGET_CHAINS
        assert TARGET_CHAINS == 25

    def test_min_amendments_is_2(self):
        from upsilon.ingestion.acquire_held_out_study import MIN_AMENDMENTS
        assert MIN_AMENDMENTS == 2

    def test_is_credit_agreement_exhibit_explicit(self):
        from upsilon.ingestion.acquire_held_out_study import is_credit_agreement_exhibit
    ...
    def test_is_composite_exhibit(self):
        from upsilon.ingestion.acquire_held_out_study import is_composite_exhibit
    ...
    def test_sha256(self):
        from upsilon.ingestion.acquire_held_out_study import sha256
        h = sha256(b"test")
        assert len(h) == 64
