...
def test_latest_version_finds_current_active_not_latest_recorded():
    ...
    """
    from upsilon.commitments.persistence import _latest_version
...
class TestPreflightChainSelection:
    def test_preflight_chains_are_five(self):
        from results.preflight.run_operational_preflight import PREFLIGHT_CHAINS
...
class TestIntegrityChecks:
    ...
    def test_temporal_check_detects_contradictory_active(self):
        ...
        from results.preflight.run_operational_preflight import check_temporal_integrity
    ...
    def test_lineage_check_detects_orphans(self):
        ...
        from results.preflight.run_operational_preflight import check_lineage_integrity
...
def test_persistence_rollback_works():
    ...
    from results.preflight.run_operational_preflight import check_persistence_rollback
