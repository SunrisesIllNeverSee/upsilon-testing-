...
from upsilon.parsing.genre_adapters import (
    GenreAdapterResult,
...
from upsilon.parsing.pattern_classifier import AmendmentPattern
...
class TestConformedCopyAdapter:
    ...
    def test_strips_html_markup(self):
        ...
        from upsilon.parsing.genre_adapters import _strip_redline_markup
