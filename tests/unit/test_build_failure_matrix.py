...
from audits.failure_census.build_failure_matrix import (
    FAILURE_CAUSES,
...
class TestS0DocumentAnalysis:
    ...
    def test_missing_s0_file_is_discovery_failure(self, tmp_chain):
        with patch("audits.failure_census.build_failure_matrix.Path") as mock_path:
...
class TestAmendmentFormatAnalysis:
    ...
    def test_redline_is_unsupported_format(self, setup_chain):
        ...
        with patch("audits.failure_census.build_failure_matrix.Path") as mock_path_class:
