...
class TestAmendedAsFollowsContainer:
    ...
    def test_container_not_in_specs(self):
        ...
        import inspect
        from upsilon.parsing.amendment_parser import _extract_instructions_v04
...
class TestSpanBasedMatching:
    ...
    def test_match_by_span_not_just_key(self):
        ...
        from data.classify_development_corpus import match_instructions_to_gold
        gold = [
...
class TestHistoricalTypeAdapter:
    ...
    def test_add_commitment_maps_to_add(self):
        from data.classify_development_corpus import _adapt_instruction_type
